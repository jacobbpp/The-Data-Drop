...
- A realistic, slightly messy dataset  
- A short client style brief that explains the scenario and the questions they care about  
...
- Build clear, simple visuals that answer basic questions from the brief  

### Tier 2: Explore and Build

- Dig deeper into the data and look for more interesting patterns or stories  
- Build something interactive. For example:
  - A dashboard with filters and drill downs  
...
- Data focused people might lead on cleaning, validation, exploratory analysis and visualisation  
- Software focused people might lead on building APIs, dashboards, apps and wiring everything together  
- Less confident team members can own testing, documentation, note taking, presentation prep and keeping the client needs in focus  
...
Use what you already know, for example:

- Python, R or SQL for data work  
- JavaScript, React or similar for front end  
- Node, Python, or another backend for APIs  
- Notebook tools or BI tools for quick visuals  
...
- Unblock you on technical issues  
- Ask awkward client style questions  
- Help you refocus if you get stuck in the weeds  
...
- Explain the client problem in simple language  
- Show a cleaned, sensible dataset  
- Demo a dashboard, app or tool that a non technical user could understand  
- Talk honestly about trade offs, what worked and what they would do next  

If you can do that, you have had a very good day.

Get your laptop ready, bring your ideas, and be prepared to ship something real in a single sprint.